...
| `project_type` | string | yes | One of: `web-app`, `data-app`, `analytics-engineering`, `data-engineering`, `ml-engineering`, `ai-engineering`, `automation`, `library`, `analytics-workspace`, `agentic-workflow`. Multi-type projects use the primary type. |
