...
| [PRD-14: Analytics Workspace Onboarding](PRD-14-analytics-workspace-onboarding.md) | 0.23.0 | Aligned | Analytics-workspace-specific onboarding during bootstrap: platform/technology identification, cost model documentation, source registry scaffolding, data governance awareness. Aligned 2026-05-02. |
